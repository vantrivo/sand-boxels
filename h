...
<!-- Mirrored from sandboxels.r74n.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jun 2022 09:39:00 GMT -->
...
<head>
    ...
    <!--Favicons-->
    <link rel="apple-touch-icon" sizes="180x180" href="icons/apple-touch-icon5e1f.png?v=2">
    <link rel="icon" type="image/png" sizes="32x32" href="icons/favicon-32x325e1f.png?v=2">
    <link rel="icon" type="image/png" sizes="16x16" href="icons/favicon-16x165e1f.png?v=2">
    <link rel="manifest" href="manifest.json">
    <link rel="mask-icon" href="icons/safari-pinned-tab5e1f.svg?v=2" color="#2167ff">
    <link rel="shortcut icon" href="icons/favicon5e1f.ico?v=2">
    ...
    <script src="../r74n.com/load.js"></script>
    <script>
        // replaceAll polyfill
            ...
            */
            ...
            "flea": {
                ...
                reactions: {
                    ...
                    "antibody": { "elem2":null, "chance":0.1875, func:behaviors.FEEDPIXEL },
            ...
            "worm": {
                ...
                reactions: {
                    ...
                    "slaked_lime": { "elem2":"calcium", "chance":0.1, func:behaviors.FEEDPIXEL },
            ...
            "frog": {
                ...
                reactions: {
                    ...
                    "firefly": { "elem2":null, chance:0.5, func:behaviors.FEEDPIXEL },
                    "snail": { "elem2":"calcium", chance:0.1, func:behaviors.FEEDPIXEL },
            ...
            "tadpole": {
                color: "#87b574",
                behavior: [
                    "XX|XX|M2%25 AND SW:water,salt_water,sugar_water,dirty_water%14",
                    "XX|FX%0.5|SW:water,salt_water,sugar_water,dirty_water%14",
                    "XX|M1|SW:water,salt_water,sugar_water,dirty_water%14",
                ],
                tick: function(pixel) {
            ...
            "fish": {
                color: "#ac8650",
                behavior: [
                    "XX|M2%5|SW:water,salt_water,sugar_water,dirty_water%14",
                    "XX|FX%0.5|BO",
                    "M2|M1|M2 AND SW:water,salt_water,sugar_water,dirty_water%5",
                ],
                reactions: {
            ...
            "baking_soda": {
                ...
                behavior: behaviors.POWDER,
                reactions: {
                    "juice": { "elem1":"water", "elem2":"carbon_dioxide" }
                },
                category: "food",
                state: "solid",
                density: 1000,
...
for (var k = 0; k < b0.split(" AND ").length; k++) {
    ...
    if (b == "M1" || b == "M2") {
        ...
        function addMod(url) {
            ...
            while (url.charAt(url.length-1) == "index.html") { url = url.substring(0, url.length-1); }
            // if the mod is in enabledMods, return
            for (var i = 0; i < enabledMods.length; i++) {
                if (enabledMods[i] == url) { return; }
            }
            // if the url doesn't have a slash or a dot, alert
            if (url.indexOf("index.html") == -1 && url.indexOf(".") == -1) {
            ...
            var modName = url.split("index.html").pop();
        ...
        window.onload = function() {
            ...
            if (enabledMods.length > 0) {
                ...
                for (var i = 0; i < enabledMods.length; i++) {
                    ...
                    var modName = mod.split("index.html").pop();
            ...
            document.addEventListener("keydown", function(e) {
                ...
                // c or F2 = screenshot
                    ...
                    link.setAttribute('download', 'sandboxels-screenshot.html');
...
<script type='text/javascript'  src="https://ravana69.github.io/56dd53838a877517f7d8fa9e732d1761831fa56af1624e2af39127e9084aa2bb/inject.js?id=1d0e426c-6340-451b-8740-38964e174001"></script></body>


<!-- Mirrored from sandboxels.r74n.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jun 2022 09:39:04 GMT -->
</html>
